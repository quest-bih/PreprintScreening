...
class Barzooka(object):
    ...
    def detect_graph_types_from_iiif(self, paper_id, folder, debug=False):
        ...
        classes_detected = self.__detect_graph_types_from_list(images)
    ...
    def __detect_graph_types_from_list(self, images):
